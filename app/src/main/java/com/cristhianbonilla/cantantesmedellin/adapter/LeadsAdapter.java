...
public class LeadsAdapter extends RecyclerView.Adapter<LeadsAdapter.LeadViewAdapter> {
    ...
    public LeadsAdapter(List<Lead> leads, LeadListFragment leadListFragment) {

        this.listaLeads = leads;
        this.fragment = leadListFragment;
